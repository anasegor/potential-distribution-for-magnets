...
// Task6.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTask6App, CWinApp)
...
// Единственный объект CTask6App

CTask6App theApp;


// Инициализация CTask6App

BOOL CTask6App::InitInstance()
{
